# Exemplo 4: perceptron de 1 camada (para uma porta lógica OR)

import numpy as np

# Definindo as entradas e saídas para a porta lógica OR
...
def calculaSaida(registro):
    ...
    # e aplica a função de ativação (chamando a função stepFunction)
...
print("O treinamento precisou passar por:", treinar(),"etapas.\n")
